...
QuitRide($userID, $rideID);
	...
	$urlAndAlert ="https://tpc353_2.encs.concordia.ca/comp353-project/index.php?alert=You will not be refund for ride number ".$rideID." and if you are joining again we will charge you again ";
