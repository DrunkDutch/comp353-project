        ...
        function GetMessages() {
            ...
            if ($status == 1) {
                ...
                $stmt = $d->conn->prepare(
					...
					from comp353.Message m join comp353.Member mem2 on comp353.m.ReceiverId = comp353.mem2.UserId 
					join comp353.Member mem on comp353.m.SenderId = comp353.mem.UserId 
