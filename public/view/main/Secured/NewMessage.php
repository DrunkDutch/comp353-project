...
<div id="page-content-wrapper">
    <div class="row">
        <div class="text-center"><i class="fa fa-commenting fa-5x" aria-hidden="true"></i>
        </div>
    </div>
    <?php include "/comp353-project/app/sendMessage.php" ?>
    <h1>Log In</h1>
    <form class="container-fluid col-md-4 col-md-offset-4" action="/comp353-project/app/sendMessage.php"
          method="POST">
