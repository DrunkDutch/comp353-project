...
<div id="page-content-wrapper">
    ...
    function GetRatingsDetails($id)
    {
        ...
        if ($status == 1) {
            ...
            $stmt = $d->conn->prepare("SELECT UName, UserId, max(Score) as High, min(Score) as Low, avg(Score) as Avg FROM ".$GLOBALS['db_name'].".Rating JOIN ".$GLOBALS['db_name'].".Member ON (UserId=RateeId) WHERE RateeId = :id");
